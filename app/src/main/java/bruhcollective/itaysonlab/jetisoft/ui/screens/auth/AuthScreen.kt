package bruhcollective.itaysonlab.jetisoft.ui.screens.auth
...
import bruhcollective.itaysonlab.jetisoft.ui.kit.ubiSecondaryButtonColors
import bruhcollective.itaysonlab.jetisoft.ui.screens.Dialog
...
import bruhcollective.itaysonlab.jetisoft.ui.theme.UbiSurfaceVariant
        ...
        Column(
            ...
            Box(
                ...
                OutlinedButton(
                    ...
                    colors = ubiSecondaryButtonColors()
                ) {
...
class AuthScreenViewModel @Inject constructor(
    ...
    fun auth(username: String, password: String, onSuccess: () -> Unit) {
        ...
        viewModelScope.launch {
            ...
            when (ubiSessionController.createSession(UbiSessionController.SessionType.EmailPassword(
